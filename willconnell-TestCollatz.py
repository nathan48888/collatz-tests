...
class TestCollatz (TestCase):
    ...
    # corner case outside of cache
    def test_eval_9(self):
      v = collatz_eval(100001, 100200)
      self.assertEqual(v, 341)

    # corner case outside of cache
    def test_eval_10(self):
      v = collatz_eval(100200, 100001)
      self.assertEqual(v, 341)
    ...
    def test_print_3(self):
        w = StringIO()
        collatz_print(w, 24, 42, 112)
        self.assertEqual(w.getvalue(), "24 42 112\n")

    # should fail
    def test_print_4(self):
        w = StringIO()
        collatz_print(w, 1, 10, 1)
        self.assertNotEqual(w.getvalue(), "1 10 20\n")
